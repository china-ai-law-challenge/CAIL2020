...
if is_torch_available():
    ...
    from .modeling_bert import (BertPreTrainedModel, BertModel, BertForPreTraining,
                                ...
                                BertForTokenClassification, BertForQuestionAnswering,BertForTokenClassificationRNN,BertForTokenClassificationRNN_v1,BertForTokenClassificationRNN_v2,BertForTokenClassificationRNN_v3,BertForTokenClassificationRNN_v4,
